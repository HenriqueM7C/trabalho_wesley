...
def alterar_preco_do_produto(nome, preco):
    for produto in produtos:
        if produto['nome'] == nome:
            produto['preco'] = produto['preco'] + preco
            return jsonify(produto)
    # Se nenhum produto com o nome especificado for encontrado, aborte com um erro 404.
    abort(404, f"Produto com nome '{nome}' não encontrado.")
